...
\section*{Blockbeschrieb}
	...
	Ziele:		&  \multicolumn{3}{p{13.5cm+4\tabcolsep+2\arrayrulewidth}|}{\begin{compactitem} % Compactitem ergibt eine Liste
		...
		\item Aufz\"ahlungpunkt
 		\item Aufz\"ahlungpunkt mit wirklich sehr langem text, wirkliech viel und noch mehr, sodass die Zeile umbricht und ich sehe was passieren wird. % Hier sind die blöden Umbrüche
 	\end{compactitem}} \\
	\hline
\end{tabular}
